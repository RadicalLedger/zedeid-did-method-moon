    ...
    it('create master node', async () => {
        ...
        expect(keys).toEqual({
            ...
            didDocument: {
                ...
                publicKey: [
                    {
                        id: 'did:moon:alpha:0x022b971dff0c43305e691ded7a14367af19d6407#owner',
                        owner: 'did:moon:alpha:0x022b971dff0c43305e691ded7a14367af19d6407',
                ...
                authentication: [
                    {
                        ...
                        publicKey: 'did:moon:alpha:0x022b971dff0c43305e691ded7a14367af19d6407#owner'
                    }
                ],
                assertionMethod: [
                    {
